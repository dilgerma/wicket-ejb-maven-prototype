...
public class SessionFacadeMock implements SessionFacade {
	 ...
	 * 
	 * @see
	 * de.md.ejb.service.SessionFacade#removeContact(de.md.ejb.contact.model
	 * .Contact)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.md.ejb.service.SessionFacade#replyTo(de.md.ejb.contact.model.Contact,
	 ...
	 * 
	 * @see
	 * de.md.ejb.service.SessionFacade#saveContact(de.md.ejb.contact.model.Contact
	 * )
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.md.ejb.service.SessionFacade#addProject(de.md.ejb.project.model.Project
	 * )
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.md.ejb.service.SessionFacade#removeProject(de.md.ejb.project.model
	 * .Project)
	 */
	@Override
