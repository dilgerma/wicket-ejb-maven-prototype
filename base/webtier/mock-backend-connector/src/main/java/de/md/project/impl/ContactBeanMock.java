...
public class ContactBeanMock implements ContactsBean {
    ...
    /* (non-Javadoc)
     * @see de.md.ejb.contact.ContactsBean#removeContact(de.md.ejb.contact.model.Contact)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see de.md.ejb.contact.ContactsBean#replyTo(de.md.ejb.contact.model.Contact, de.md.ejb.contact.model.Contact)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see de.md.ejb.contact.ContactsBean#saveContact(de.md.ejb.contact.model.Contact)
     */
    @Override
	...
	Contact c1 = new Contact("Hans Mueller","hans.mueller@web.de",new Date(), ContactReason.COMMENT, "nette Seite");
	c1.setId(1l);
	Contact c2 = new Contact("Gerda Weibel","gerda.weibel@gmx.de",new Date(), ContactReason.COMMENT, "Gefällt mir, das Layout");
	c2.setId(2l);
