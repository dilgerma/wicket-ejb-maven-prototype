...
public abstract class BasePageWithMenu extends BasePage {
	...
	protected List<MenuItem<? extends Page>> createMenuItems() {
		...
		MenuItem<ProjectsPage> blog = new MenuItem<ProjectsPage>("Blog",
				"Blog", ProjectsPage.class);
	...
	/**
	 * Initializes Menu-Navigation. If you do not need any menu, just do not
	 * call super-Implementation in Subclasses.
	 * */
	@Override
