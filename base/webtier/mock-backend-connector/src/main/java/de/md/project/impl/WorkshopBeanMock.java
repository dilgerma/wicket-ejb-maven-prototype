...
public class WorkshopBeanMock implements WorkshopBean {
	...
	private void initStaticData() {
		...
		Attachment att2 = new Attachment(2, "/home/user/slides.ppt",
				"the slides");

		attachmentList.add(att1);
		attachmentList.add(att2);

		Workshop workshop = new Workshop("RCP", "This is a RCP Workshop",
				"This is the summary", attachmentList);
	 ...
	 * 
	 * @see
	 * de.md.ejb.workshop.WorkshopBean#saveWorkshop(de.md.ejb.workshop.model
	 * .Workshop)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.md.ejb.workshop.WorkshopBean#removeWorkshop(de.md.ejb.workshop.model
	 * .Workshop)
	 */
	@Override
