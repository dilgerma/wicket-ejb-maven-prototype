...
/**
 * Simple Frontend Mock, that allows development without any DB, EJB on a simple
 * Tomcat-Instance.
 * 
 * @author dilgerma
 * 
...
public class ProjectBeanMock implements ProjectLoaderBean {
	...
	private void initMockData() {
		...
		Project project = new Project("EJB Implementation",
				"Insurance Nuremberg", "Project Implementing Business Logic",
				techList1, new ArrayList<Attachment>());
		project.setId(1);
		Project project2 = new Project("Wicket Implementation",
				"Telecommunication Munich", "First Wicket Implementation",
				techList2, new ArrayList<Attachment>());
		project2.setId(2);
		addProject(project);
		addProject(project2);
	}
